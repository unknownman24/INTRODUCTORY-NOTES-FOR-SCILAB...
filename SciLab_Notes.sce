...
//lgnd_bar=legend(['Conical Gear Systems','Rack & Pinion Gear Systems','Worm Gear Systems']);
...
//  If you want to change the axis properties of the graph, the code must be changed as below.
//  NEW_NAME=gca();
//  NEW_NAME.x_ticks.labels=["N1";"N2";"N3";"N4";"N5";"N6";"N7"...;"NN"]

//new_x_label=gca();
//new_x_label.x_ticks.labels=["JAN";"FEB";"MAR";"APR";"MAY";"JUN";"JUL";"AUG";"SEP";"OCT";"NOV";"DEC"];
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
////////////------------------------------------------------------------------------------////////////
////////////         HOW TO DRAW LINE GRAPHS IN SCILAB FOR MATHEMATICAL EQUATIONS         ////////////
////////////------------------------------------------------------------------------------////////////

...
//  This section is about drawing line graphs of mathematical equations in SCILAB.
//  Let's define two different equations which are called as Equation_1 and Equation_2 as seen below.
//  In order to define these equations as line graph, the x-axis values are required to be defined.
//  x-axis values has been defined as x1 as shown in below
...
// If you want to encolour your line graph and if you want to organise it,
// the command must be converted to "plot(x_axis,Equation_name,'line_style-line_colour')"

plot(x1,Equation_1,'x-b');
plot(x1,Equation_2,'x-r');
...
//lgnd_line=legend(['Equation_1','Equation_2'],pos=5);
lgnd_line=legend(['$x^2+2*x+1$';'$x^2-2*x-1$'],pos=5);
bb=gca();
bb.font_size=4;
bb.x_label.font_size=4;
bb.y_label.font_size=4;
bb.title.font_size=4;


//////////////////////////////////////////////////////////////////////////////////////////////////////
////////////------------------------------------------------------------------------------////////////
////////////                      MAIN LINE STYLES&COLOURS IN SCILAB                      ////////////
////////////------------------------------------------------------------------------------////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
///////----------------------------------------------------------------------------------------///////
///////         Sign                   Meaning             Colour Sign         Meaning         ///////
///////----------------------------------------------------------------------------------------///////
///////          -                   Solid Line                k               Black           ///////
///////          --                  Dashed Line               w               White           ///////
///////          :                   Dotted Line               m               Magenta         ///////
///////          -.                  Dashed Dotted             g               Green           ///////
///////          +                   Plus Sign                 r               Red             ///////
///////          o                   Circle                    b               Blue            ///////
///////          *                   Asterisk                  c               Cyan            ///////
///////          .                   Point                     y               Yellow          ///////
///////          x                   Cross                                                     ///////
///////          's'                 Square                                                    ///////
///////          ^                   Upper point triangles                                     ///////
///////          v                   Lower point triangles                                     ///////
///////          >                   Right point triangles                                     ///////
///////          <                   Left point triangles                                      ///////
///////      'pentagon'              Five armed star                                           ///////
///////----------------------------------------------------------------------------------------///////
//////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////
